...
#define TUD_XINPUT_DESC_LEN 153
...
#define TUD_XINPUT_DESCRIPTOR(_itfnum, _stridx, _epout, _epin, _epsize, _ep_interval) \
  ...
  17, HID_DESC_TYPE_HID, U16_TO_U8S_LE(0x0100), 0x01, 0x25, _epin, 0x14, 0x00, 0x00, 0x00, 0x13, _epout, 0x08, 0x00, 0x00, \
  ...
  9, TUSB_DESC_INTERFACE, (uint8_t)((_itfnum) + 3), 0, 0, TUSB_CLASS_VENDOR_SPECIFIC, 0xFD, 0x13, 0, \
